...
<!-- UsageSnippet language="php" operationID="createWallet" method="post" path="/accounts/{accountID}/wallets" -->
```php
...
<!-- UsageSnippet language="php" operationID="updateWallet" method="patch" path="/accounts/{accountID}/wallets/{walletID}" -->
```php
declare(strict_types=1);
