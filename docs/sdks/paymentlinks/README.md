...
$createPaymentLink = new Components\CreatePaymentLink(
    ...
    display: new Components\PaymentLinkDisplayOptions(
        ...
        callToAction: Components\CallToAction::Donate,
    ),
    customer: new Components\PaymentLinkCustomerOptions(
        requirePhone: true,
    ),
    customAmountPayment: new Components\PaymentLinkCustomAmountPaymentDetails(
        allowedMethods: [
            Components\CollectionPaymentMethodType::CardPayment,
            Components\CollectionPaymentMethodType::AchDebitCollect,
        ],
        amountRange: new Components\AmountDecimalRange(
            minimum: new Components\AmountDecimal(
                currency: 'USD',
                valueDecimal: '0.00',
            ),
            maximum: new Components\AmountDecimal(
                currency: 'USD',
