...
$createPaymentLink = new Components\CreatePaymentLink(
    ...
    display: new Components\PaymentLinkDisplayOptions(
        ...
        callToAction: Components\CallToAction::Confirm,
    ),
    payout: new Components\PaymentLinkPayoutDetails(
        allowedMethods: [
            Components\DisbursementPaymentMethodType::PushToCard,
            Components\DisbursementPaymentMethodType::PushToApplePay,
            Components\DisbursementPaymentMethodType::RtpCredit,
            Components\DisbursementPaymentMethodType::AchCreditStandard,
        ],
        recipient: new Components\PayoutRecipient(
            email: 'jordan@example.com',
        ),
        pushOptions: new Components\PushOptions(
            allowedSpeeds: [
        ...
        feePaidBy: [
            'instant-push-to-card' => Components\FeePaidBy::Destination,
            'deferred-push-to-card' => Components\FeePaidBy::Source,
            'instant-push-to-apple-pay' => Components\FeePaidBy::Destination,
            'rtp-credit' => Components\FeePaidBy::Destination,
        ],
    ),
);
...
| `createPaymentLink`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 | [Components\CreatePaymentLink](../../Models/Components/CreatePaymentLink.md)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        | :heavy_check_mark:                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  | N/A                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 | {<br/>"partnerAccountID": "d290f1ee-6c54-4b01-90e6-d701748f0851",<br/>"merchantPaymentMethodID": "4c4e7f8e-81f4-4f3d-8f6f-6f6e7f8e4c4e",<br/>"amount": {<br/>"currency": "USD",<br/>"value": 2500<br/>},<br/>"display": {<br/>"title": "Claim your payout",<br/>"description": "Q3 rebate payout.",<br/>"callToAction": "confirm"<br/>},<br/>"payout": {<br/>"allowedMethods": [<br/>"push-to-card",<br/>"push-to-apple-pay",<br/>"rtp-credit",<br/>"ach-credit-standard"<br/>],<br/>"pushOptions": {<br/>"allowedSpeeds": [<br/>"instant",<br/>"deferred"<br/>],<br/>"deferredBy": "24h"<br/>},<br/>"recipient": {<br/>"email": "jordan@example.com"<br/>},<br/>"feePaidBy": {<br/>"instant-push-to-card": "destination",<br/>"deferred-push-to-card": "source",<br/>"instant-push-to-apple-pay": "destination",<br/>"rtp-credit": "destination"<br/>}<br/>}<br/>} |
