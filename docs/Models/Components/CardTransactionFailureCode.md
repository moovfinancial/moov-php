...
| `CardholderActionRequired`  | cardholder-action-required  |
| `FormatError`               | format-error                |
| `InvalidPin`                | invalid-pin                 |
| `OfflineApproved`           | offline-approved            |
| `OfflineDeclined`           | offline-declined            |
| `PartialApproval`           | partial-approval            |
| `PaymentStopped`            | payment-stopped             |
| `PinRequired`               | pin-required                |
| `RecordNotFound`            | record-not-found            |
| `SurchargeNotPermitted`     | surcharge-not-permitted     |
