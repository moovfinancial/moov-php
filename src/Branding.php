...
class Branding
{
     ...
     * @throws \Moov\MoovPhp\Models\Errors\APIException
     */
    public function update(Components\UpdateBrand $updateBrand, string $accountID, ?string $xMoovVersion = null, ?Options $options = null): Operations\UpdateBrandResponse
    {
        ...
        $baseUrl = $this->sdkConfiguration->getTemplatedServerUrl();
        $url = Utils\Utils::generateUrl($baseUrl, '/accounts/{accountID}/branding', Operations\UpdateBrandRequest::class, $request, $this->sdkConfiguration->globals);
        $urlOverride = null;
        $httpOptions = ['http_errors' => false];
        ...
        $hookContext = new HookContext($this->sdkConfiguration, $baseUrl, 'updateBrand', null, $this->sdkConfiguration->securitySource);
        $httpRequest = $this->sdkConfiguration->hooks->beforeRequest(new Hooks\BeforeRequestContext($hookContext), $httpRequest);
        $httpOptions = Utils\Utils::convertHeadersToOptions($httpRequest, $httpOptions);
        $httpRequest = Utils\Utils::removeHeaders($httpRequest);
        try {
