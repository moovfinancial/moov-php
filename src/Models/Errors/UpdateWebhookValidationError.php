...
class UpdateWebhookValidationError
{
    /**
    ...
    public function toException(): UpdateWebhookValidationErrorThrowable
    {
        $serializer = Utils\JSON::createSerializer();
        $message = $serializer->serialize($this, 'json');
        $code = -1;

        return new UpdateWebhookValidationErrorThrowable($message, (int) $code, $this);
    }
}