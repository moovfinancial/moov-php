...
class UploadDisputeEvidenceFileRequest
{
     ...
     * @phpstan-pure
     */
    public function __construct(string $accountID, string $disputeID, Components\CreateEvidenceFileMultiPart $createEvidenceFileMultiPart, ?string $xMoovVersion = null)
    {
