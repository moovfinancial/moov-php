...
class UploadDisputeEvidenceFileRequest
{
     ...
     * @phpstan-pure
     */
    public function __construct(string $accountID, string $disputeID, Components\CreateEvidenceFileMultiPart $createEvidenceFileMultiPart, ?string $xMoovVersion = 'v2024.01.00')
    {
