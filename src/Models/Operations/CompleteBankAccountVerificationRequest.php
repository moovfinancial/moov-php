...
class CompleteBankAccountVerificationRequest
{
     ...
     * @phpstan-pure
     */
    public function __construct(string $accountID, string $bankAccountID, Components\CompleteBankAccountVerification $completeBankAccountVerification, ?string $xMoovVersion = 'v2024.01')
    {
