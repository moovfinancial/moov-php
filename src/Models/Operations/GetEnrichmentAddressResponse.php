...
class GetEnrichmentAddressResponse
{
     ...
     */
    public function __construct(string $contentType, int $statusCode, \Psr\Http\Message\ResponseInterface $rawResponse, ?Components\EnrichedAddressResponse $enrichedAddressResponse = null)
    {
        $this->contentType = $contentType;
        $this->statusCode = $statusCode;
        $this->rawResponse = $rawResponse;
        $this->enrichedAddressResponse = $enrichedAddressResponse;
    }
}