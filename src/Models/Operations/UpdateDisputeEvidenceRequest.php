...
class UpdateDisputeEvidenceRequest
{
     ...
     */
    public function __construct(string $accountID, string $disputeID, string $evidenceID, Components\UpdateEvidence $updateEvidence, ?Components\Versions $xMoovVersion = null)
    {
