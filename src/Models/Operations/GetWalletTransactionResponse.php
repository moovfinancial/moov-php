...
class GetWalletTransactionResponse
{
     ...
     */
    public function __construct(string $contentType, int $statusCode, \Psr\Http\Message\ResponseInterface $rawResponse, ?Components\WalletTransaction $walletTransaction = null)
    {
