...
class CreateWebhookRequest
{
    /**
     *
     * @var Components\CreateWebhook $createWebhook
     */
    #[SpeakeasyMetadata('request:mediaType=application/json')]
    public Components\CreateWebhook $createWebhook;
     ...
     * @phpstan-pure
     */
    public function __construct(Components\CreateWebhook $createWebhook, ?string $xMoovVersion = null)
    {
