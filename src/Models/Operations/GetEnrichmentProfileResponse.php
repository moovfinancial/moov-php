...
class GetEnrichmentProfileResponse
{
     ...
     */
    public function __construct(string $contentType, int $statusCode, \Psr\Http\Message\ResponseInterface $rawResponse, ?Components\EnrichedBusinessProfile $enrichedBusinessProfile = null)
    {
