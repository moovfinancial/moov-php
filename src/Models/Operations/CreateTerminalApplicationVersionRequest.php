...
class CreateTerminalApplicationVersionRequest
{
     ...
     * @phpstan-pure
     */
    public function __construct(string $terminalApplicationID, Components\TerminalApplicationVersion $terminalApplicationVersion, ?string $xMoovVersion = 'v2024.01.00')
    {
