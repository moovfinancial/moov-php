...
class AssignAccountCountriesResponse
{
    /**
     ...
     */
    public function __construct(string $contentType, int $statusCode, \Psr\Http\Message\ResponseInterface $rawResponse, ?Components\AccountCountries $accountCountries = null)
    {
