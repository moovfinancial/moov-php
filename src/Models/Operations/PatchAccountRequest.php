...
class PatchAccountRequest
{
    ...
    /**
     *
     * @var Components\CreateAccountUpdate $createAccountUpdate
     */
    #[SpeakeasyMetadata('request:mediaType=application/json')]
    public Components\CreateAccountUpdate $createAccountUpdate;
     ...
     */
    public function __construct(string $accountID, Components\CreateAccountUpdate $createAccountUpdate, ?Components\Versions $xMoovVersion = null)
    {
