...
class GetFullIssuedCardResponse
{
     ...
     */
    public function __construct(string $contentType, int $statusCode, \Psr\Http\Message\ResponseInterface $rawResponse, ?Components\FullIssuedCard $fullIssuedCard = null)
    {
