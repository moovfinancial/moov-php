...
class InitiateRefundRequest
{
     ...
     * @phpstan-pure
     */
    public function __construct(string $xIdempotencyKey, string $accountID, string $transferID, ?Components\TransferWaitFor $xWaitFor = null, ?Components\CreateRefund $createRefund = null, ?string $xMoovVersion = 'v2024.01')
    {
