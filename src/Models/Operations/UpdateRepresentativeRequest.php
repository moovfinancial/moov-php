...
class UpdateRepresentativeRequest
{
     ...
     * @phpstan-pure
     */
    public function __construct(string $accountID, string $representativeID, Components\UpdateRepresentative $updateRepresentative, ?string $xMoovVersion = 'v2024.01')
    {
