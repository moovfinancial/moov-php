...
class RefundTransferResponse
{
     ...
     */
    public function __construct(string $contentType, int $statusCode, \Psr\Http\Message\ResponseInterface $rawResponse, Components\CardAcquiringRefund|Components\AsyncCreatedRefund|null $createRefundResponse = null, ?Components\CardAcquiringRefund $cardAcquiringRefund = null)
    {
