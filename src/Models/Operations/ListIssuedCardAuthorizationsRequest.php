...
class ListIssuedCardAuthorizationsRequest
{
     ...
     * @phpstan-pure
     */
    public function __construct(string $accountID, ?int $skip = null, ?int $count = null, ?string $issuedCardID = null, ?\DateTime $startDateTime = null, ?\DateTime $endDateTime = null, ?array $statuses = null, ?string $xMoovVersion = 'v2024.01.00')
    {
