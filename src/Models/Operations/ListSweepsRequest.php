...
class ListSweepsRequest
{
     ...
     * @phpstan-pure
     */
    public function __construct(string $accountID, string $walletID, ?int $skip = null, ?int $count = null, ?Components\SweepStatus $status = null, ?string $statementDescriptor = null, ?string $xMoovVersion = 'v2024.01')
    {
