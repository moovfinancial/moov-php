...
class ListSweepsRequest
{
     ...
     * @phpstan-pure
     */
    public function __construct(string $accountID, string $walletID, ?string $xMoovVersion = null, ?int $skip = null, ?int $count = null, ?Components\SweepStatus $status = null, ?string $statementDescriptor = null)
    {
