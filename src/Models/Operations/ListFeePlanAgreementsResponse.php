...
class ListFeePlanAgreementsResponse
{
    /**
     ...
     */
    public function __construct(string $contentType, int $statusCode, \Psr\Http\Message\ResponseInterface $rawResponse, ?array $feePlanAgreements = null)
    {
