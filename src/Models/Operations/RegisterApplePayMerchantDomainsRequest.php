...
class RegisterApplePayMerchantDomainsRequest
{
     ...
     * @phpstan-pure
     */
    public function __construct(string $accountID, Components\RegisterApplePayMerchantDomains $registerApplePayMerchantDomains, ?string $xMoovVersion = 'v2024.01.00')
    {
