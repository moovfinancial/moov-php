...
class UpdateImageRequest
{
     ...
     * @phpstan-pure
     */
    public function __construct(string $accountID, string $imageID, Components\ImageUpdateRequestMultiPart $imageUpdateRequestMultiPart, ?string $xMoovVersion = 'v2024.01.00')
    {
