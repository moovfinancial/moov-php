...
class CreateSweepConfigResponse
{
    /**
     ...
     */
    public function __construct(string $contentType, int $statusCode, \Psr\Http\Message\ResponseInterface $rawResponse, ?Components\SweepConfig $sweepConfig = null)
    {
