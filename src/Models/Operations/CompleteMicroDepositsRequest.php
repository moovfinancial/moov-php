...
class CompleteMicroDepositsRequest
{
     ...
     * @phpstan-pure
     */
    public function __construct(string $accountID, string $bankAccountID, Components\CompleteMicroDeposits $completeMicroDeposits, ?string $xMoovVersion = 'v2024.01.00')
    {
