...
class ListResidualsRequest
{
     ...
     * @phpstan-pure
     */
    public function __construct(string $accountID, ?int $skip = null, ?int $count = null, ?string $startDateTime = null, ?string $endDateTime = null, ?string $xMoovVersion = 'v2024.01.00')
    {
