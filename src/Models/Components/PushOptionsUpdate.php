...
class PushOptionsUpdate
{
    ...
    #[\Speakeasy\Serializer\Annotation\Type('array<\Moov\MoovPhp\Models\Components\PushDeliverySpeed>|null')]
     ...
     * @phpstan-pure
     */
    public function __construct(?array $allowedSpeeds = null, ?string $deferredBy = null)
    {
