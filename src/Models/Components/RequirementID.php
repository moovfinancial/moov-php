...
enum RequirementID: string
{
    ...
    case UnderwritingSendFundsWireCardAcceptanceMethods = 'underwriting.sendFunds.wire.cardAcceptanceMethods';
    case UnderwritingSendFundsWireCurrentlyAcceptsCards = 'underwriting.sendFunds.wire.currentlyAcceptsCards';
    case UnderwritingSendFundsWireEstimatedActivityAverageTransactionAmount = 'underwriting.sendFunds.wire.estimatedActivity.averageTransactionAmount';
    case UnderwritingSendFundsWireEstimatedActivityMaximumTransactionAmount = 'underwriting.sendFunds.wire.estimatedActivity.maximumTransactionAmount';
    case UnderwritingSendFundsWireEstimatedActivityMonthlyVolumeRange = 'underwriting.sendFunds.wire.estimatedActivity.monthlyVolumeRange';
    case UnderwritingSendFundsWireFulfillment = 'underwriting.sendFunds.wire.fulfillment';
    case UnderwritingSendFundsWireRefundPolicy = 'underwriting.sendFunds.wire.refundPolicy';
    ...
    case UnderwritingCardIssuingEstimatedActivityMonthlyVolumeRange = 'underwriting.cardIssuing.estimatedActivity.monthlyVolumeRange';
}
