...
class InvoiceLineItemValidationError
{
     ...
     * $options
     *
     * @var ?array<string, \Moov\MoovPhp\Models\Components\InvoiceLineItemOptionValidationError> $options
     */
     ...
     * @param  ?array<string, \Moov\MoovPhp\Models\Components\InvoiceLineItemOptionValidationError>  $options
