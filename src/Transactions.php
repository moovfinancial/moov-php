...
class Transactions
{
    ...
    public function get(string $accountID, string $cardTransactionID, ?string $xMoovVersion = null, ?Options $options = null): Operations\GetIssuedCardTransactionResponse
    {
        ...
        $hookContext = new HookContext($this->sdkConfiguration, $baseUrl, 'getIssuedCardTransaction', null, $this->sdkConfiguration->securitySource);
        ...
        if (Utils\Utils::matchStatusCodes($statusCode, ['200'])) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $obj = $serializer->deserialize($responseData, '\Moov\MoovPhp\Models\Components\IssuedCardTransaction', 'json', DeserializationContext::create()->setRequireAllRequiredProperties(true));
