...
class Underwriting
{
     ...
     * @throws \Moov\MoovPhp\Models\Errors\APIException
     */
    public function save(Components\UpsertUnderwriting $upsertUnderwriting, string $accountID, ?string $xMoovVersion = null, ?Options $options = null): Operations\SaveUnderwritingResponse
    {
        ...
        $baseUrl = $this->sdkConfiguration->getTemplatedServerUrl();
        $url = Utils\Utils::generateUrl($baseUrl, '/accounts/{accountID}/underwriting', Operations\SaveUnderwritingRequest::class, $request, $this->sdkConfiguration->globals);
        $urlOverride = null;
        $httpOptions = ['http_errors' => false];
