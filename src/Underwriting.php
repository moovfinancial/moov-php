...
class Underwriting
{
    ...
    public function get(string $accountID, ?string $xMoovVersion = null, ?Options $options = null): Operations\GetUnderwritingResponse
    {
        ...
        $hookContext = new HookContext($this->sdkConfiguration, $baseUrl, 'getUnderwriting', [], $this->sdkConfiguration->securitySource);
    ...
    public function save(Components\UpsertUnderwriting $upsertUnderwriting, string $accountID, ?string $xMoovVersion = null, ?Options $options = null): Operations\SaveUnderwritingResponse
    {
        ...
        $hookContext = new HookContext($this->sdkConfiguration, $baseUrl, 'saveUnderwriting', [], $this->sdkConfiguration->securitySource);
        $httpRequest = $this->sdkConfiguration->hooks->beforeRequest(new Hooks\BeforeRequestContext($hookContext), $httpRequest);
        $httpOptions = Utils\Utils::convertHeadersToOptions($httpRequest, $httpOptions);
        $httpRequest = Utils\Utils::removeHeaders($httpRequest);
        try {
    ...
    public function upsert(Components\UpdateUnderwriting $updateUnderwriting, string $accountID, ?string $xMoovVersion = null, ?Options $options = null): Operations\UpsertUnderwritingResponse
    {
        ...
        $hookContext = new HookContext($this->sdkConfiguration, $baseUrl, 'upsertUnderwriting', [], $this->sdkConfiguration->securitySource);
        $httpRequest = $this->sdkConfiguration->hooks->beforeRequest(new Hooks\BeforeRequestContext($hookContext), $httpRequest);
        $httpOptions = Utils\Utils::convertHeadersToOptions($httpRequest, $httpOptions);
        $httpRequest = Utils\Utils::removeHeaders($httpRequest);
        try {
