...
class EnrichedAddress
{
     ...
     *
     * @param  Operations\GetEnrichmentAddressSecurity  $security
     ...
     */
    public function getEnrichmentAddress(Operations\GetEnrichmentAddressSecurity $security, Operations\GetEnrichmentAddressRequest $request, ?Options $options = null): Operations\GetEnrichmentAddressResponse
    {
        ...
        $qp = Utils\Utils::getQueryParams(Operations\GetEnrichmentAddressRequest::class, $request, $urlOverride);
        ...
        $hookContext = new HookContext('getEnrichmentAddress', null, fn () => $security);
        ...
        if ($statusCode == 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $obj = $serializer->deserialize($responseData, '\Moov\OpenAPI\Models\Components\EnrichedAddressResponse', 'json', DeserializationContext::create()->setRequireAllRequiredProperties(true));
