...
class WalletTransactions
{
    ...
    public function get(string $accountID, string $walletID, string $transactionID, ?string $xMoovVersion = null, ?Options $options = null): Operations\GetWalletTransactionResponse
    {
        ...
        $hookContext = new HookContext('getWalletTransaction', null, $this->sdkConfiguration->securitySource);
     ...
     * @throws \Moov\OpenAPI\Models\Errors\APIException
     */
    public function list(Operations\ListWalletTransactionsRequest $request, ?Options $options = null): Operations\ListWalletTransactionsResponse
    {
        $baseUrl = $this->sdkConfiguration->getServerUrl();
