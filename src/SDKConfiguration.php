...
class SDKConfiguration
{
    ...
    public string $sdkVersion = '26.4.0-beta.11';

    public string $genVersion = '2.836.5';

    public string $userAgent = 'speakeasy-sdk/php 26.4.0-beta.11 2.836.5 v2026.04.00 moov/moov-php';
