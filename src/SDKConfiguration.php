...
class SDKConfiguration
{
    ...
    public string $sdkVersion = '26.4.0-beta.0';

    public string $genVersion = '2.803.3';

    public string $userAgent = 'speakeasy-sdk/php 26.4.0-beta.0 2.803.3 v2026.04.00 moov/moov-php';
