...
class SDKConfiguration
{
    ...
    public string $sdkVersion = '26.4.0-beta.6';

    public string $genVersion = '2.818.4';

    public string $userAgent = 'speakeasy-sdk/php 26.4.0-beta.6 2.818.4 v2026.04.00 moov/moov-php';
