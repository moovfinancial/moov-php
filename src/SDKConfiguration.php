...
class SDKConfiguration
{
    ...
    public string $sdkVersion = '26.4.0-beta.8';

    public string $genVersion = '2.823.1';

    public string $userAgent = 'speakeasy-sdk/php 26.4.0-beta.8 2.823.1 v2026.04.00 moov/moov-php';
