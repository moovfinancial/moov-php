...
class SDKConfiguration
{
    ...
    public string $sdkVersion = '26.4.0-beta.12';

    public string $genVersion = '2.856.1';

    public string $userAgent = 'speakeasy-sdk/php 26.4.0-beta.12 2.856.1 v2026.04.00 moov/moov-php';
