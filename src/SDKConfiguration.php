...
class SDKConfiguration
{
    ...
    public string $sdkVersion = '26.4.0-beta.13';

    public string $genVersion = '2.859.2';

    public string $userAgent = 'speakeasy-sdk/php 26.4.0-beta.13 2.859.2 v2026.04.00 moov/moov-php';
