...
class SDKConfiguration
{
    ...
    public string $sdkVersion = '26.4.0-beta.2';

    public string $genVersion = '2.811.2';

    public string $userAgent = 'speakeasy-sdk/php 26.4.0-beta.2 2.811.2 v2026.04.00 moov/moov-php';
