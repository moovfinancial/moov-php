...
class SDKConfiguration
{
    ...
    public string $sdkVersion = '26.4.0-beta.7';

    public string $genVersion = '2.821.8';

    public string $userAgent = 'speakeasy-sdk/php 26.4.0-beta.7 2.821.8 v2026.04.00 moov/moov-php';
