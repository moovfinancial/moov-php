...
class SDKConfiguration
{
    ...
    public string $sdkVersion = '26.4.0-beta.5';

    public string $genVersion = '2.816.0';

    public string $userAgent = 'speakeasy-sdk/php 26.4.0-beta.5 2.816.0 v2026.04.00 moov/moov-php';
