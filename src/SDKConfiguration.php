...
class SDKConfiguration
{
    ...
    public string $sdkVersion = '26.4.0-beta.4';

    public string $genVersion = '2.814.0';

    public string $userAgent = 'speakeasy-sdk/php 26.4.0-beta.4 2.814.0 v2026.04.00 moov/moov-php';
