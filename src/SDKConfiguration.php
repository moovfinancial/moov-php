...
class SDKConfiguration
{
    ...
    public string $sdkVersion = '26.4.0-beta.20';

    public string $genVersion = '2.881.2';

    public string $userAgent = 'speakeasy-sdk/php 26.4.0-beta.20 2.881.2 v2026.04.00 moov/moov-php';
