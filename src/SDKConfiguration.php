...
class SDKConfiguration
{
    ...
    public string $sdkVersion = '26.4.0-beta.1';

    public string $genVersion = '2.811.0';

    public string $userAgent = 'speakeasy-sdk/php 26.4.0-beta.1 2.811.0 v2026.04.00 moov/moov-php';
