...
class TerminalConfigurations
{
     ...
     */
    public function get(string $accountID, string $terminalApplicationID, ?string $xMoovVersion = null, ?Options $options = null): Operations\GetTerminalConfigurationResponse
    {
        ...
        $hookContext = new HookContext($baseUrl, 'getTerminalConfiguration', null, $this->sdkConfiguration->securitySource);
